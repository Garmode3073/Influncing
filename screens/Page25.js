    ...
    <SafeAreaView style={styles.body}>
      ...
      <ScrollView>
        ...
        <View style={styles.main}>
          ...
          <View style={{ padding: 10, display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "space-evenly" }}>

            <View style={{ width: 120, height: 120, backgroundColor: "#000", borderRadius: 10, marginRight: 10 }}></View>

            <View>
              <View style={{ display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "space-evenly", }}>
                <View style={{ width: 65, height: 55, backgroundColor: "#000", borderRadius: 7, margin: 3 }}></View>
                <View style={{ width: 65, height: 55, backgroundColor: "#000", borderRadius: 7, margin: 3 }}></View>
              </View>
              <View style={{ display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "space-evenly" }}>
                <View style={{ width: 65, height: 55, backgroundColor: "#000", borderRadius: 7, margin: 3 }}></View>
